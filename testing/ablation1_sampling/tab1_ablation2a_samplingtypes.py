...
def read_excel_and_plot(tabs, name, pdf_or_png, keys_list):
    ...
    keys_list = ['Equidistant', 'Gaussian', 'Stochastic']
    ssim_results = [88.27, 90.67, 94.82]

    bar_container = ax.bar(keys_list, ssim_results, color=bar_colors, width=0.8)

    # ax.set_xlabel('Sampling Type')
    # ax.set_ylabel('SSIM')
    ax.set(ylabel='SSIM', xlabel='Sampling Type', ylim=(70, 100))
...
if __name__ == "__main__":
    ...
    conditional_filename =  './results/ablation/ablation2a_samplingtypes/{}/'.format(filename) 
    mkdir(conditional_filename)

    tab1_a = {
                
                "Linear": './results/ablation/ablation2a_samplingtypes/ixi_t1_linear_moderate_Axial_None20230527-155734.xlsx',
                "Nonlinear": './results/ablation/ablation2a_samplingtypes/ixi_t1_nonlinear_moderate_Axial_None20230527-155938.xlsx',
                "Sudden": './results/ablation/ablation2a_samplingtypes/ixi_t1_sudden_moderate_Axial_None20230527-160142.xlsx',
                "Single-shot": './results/ablation/ablation2a_samplingtypes/ixi_t1_singleshot_moderate_Axial_None20230527-160257.xlsx',
                "RL": './results/ablation/ablation2a_samplingtypes/ixi_t1_periodic_slight_rl_Axial_None20230527-180712.xlsx',
                "Moderate": './results/ablation/ablation2a_samplingtypes/ixi_t1_periodic_moderate_Axial_None20230527-160530.xlsx',
                "Heavy": './results/ablation/ablation2a_samplingtypes/ixi_t1_periodic_heavy_Axial_None20230527-160646.xlsx',
    }

    keys_list = ['equidistant', 'gaussian', 'random']
