...
def read_excel_and_plot(tabs, name, pdf_or_png, keys_list):
    ...
    keys_list = [10, 14, 18, 23, 27, 31, 35]
    plt.plot(keys_list, ssim_results, marker='o', alpha=0.4, linewidth=3)
    plt.xlabel('Sampling Center Ratio (%)')
    plt.ylabel('SSIM')
...
if __name__ == "__main__":
    ...
    conditional_filename =  './results/ablation/ablation2b_centerratio/{}/'.format(filename) 
    mkdir(conditional_filename)

    tab1_a = {
                
                "Linear": './results/ablation/ablation2b_centerratio/ixi_t1_linear_moderate_Axial_None20230527-160939.xlsx',
                "Nonlinear": './results/ablation/ablation2b_centerratio/ixi_t1_nonlinear_moderate_Axial_None20230527-161231.xlsx',
                "Sudden": './results/ablation/ablation2b_centerratio/ixi_t1_sudden_moderate_Axial_None20230527-161523.xlsx',
                "Single-shot": './results/ablation/ablation2b_centerratio/ixi_t1_singleshot_moderate_Axial_None20230527-161814.xlsx',
                "RL": './results/ablation/ablation2b_centerratio/ixi_t1_periodic_slight_rl_Axial_None20230527-180545.xlsx',
                "Moderate": './results/ablation/ablation2b_centerratio/ixi_t1_periodic_moderate_Axial_None20230527-162354.xlsx',
                "Heavy": './results/ablation/ablation2b_centerratio/ixi_t1_periodic_heavy_Axial_None20230527-162644.xlsx',
    }

    keys_list = ['24', '34', '44', '54', '64', '74', '84']
