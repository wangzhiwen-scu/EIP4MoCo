...
# from training.train_models.csmri_ei_tta import ModelSet as OursModel  #! last excel using this

# from training.train_models.ACCS_csmri_and_ei_tvloss_prior_bezier import ModelSet as OursModel
# from training.train_models.ACCS_csmri_and_ei_tvloss_prior_sampcenter import ModelSet as OursModel
# from training.train_models.csmri_newei import ModelSet as OursModel
# from training.train_models.csmri_newei_singleshot import ModelSet as OursModel
...
def test():
    ...
    # ourtta = 'ixi_t1_singleshot_slight'
    ourtta = 'ixi_t1_singleshot_moderate'
    ...
    with torch.no_grad():
        for x_iter in dataloader:
            ...
            imgs['MARC'] = tensor2np(recon_marc)
