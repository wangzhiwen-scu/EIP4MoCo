...
class NameSpace(object):
    def __init__(self, figs):
        ...
        if figs == 2:
            ...
            # self.bbox1 = (100, 140, 190, 230) # 矩形框的左上角坐标是 (100, 140)，右下角坐标是 (190, 230)。
            self.bbox1 = (180, 140, 270, 230) # 
            self.THE_ONE = 917
...
def test():
    ...
    ourtta = 'liverhccseg_pre_moderate_respiratory'
    ...
    with torch.no_grad():
        for x_iter in dataloader:
            ...
            NUM_SLICE += 1
            if NUM_SLICE != namespace.THE_ONE:
                continue
            ...
            get_seg_ablation_map(args, imgs, NUM_SLICE, df, data_name, shotname, keys_list, namespace=namespace, dpi=200, oneline=True) # for one line.
