...
class NameSpace(object):
    def __init__(self, figs):
        ...
        if figs == 2:
            ...
            self.bbox1 = (60, 60+40, 150, 150+40)
            self.THE_ONE = 1467
...
def test():
    ...
    ourtta = 'acdc_cardiac_motion_superslight'
    ...
    with torch.no_grad():
        for x_iter in dataloader:
            ...
            get_seg_ablation_map(args, imgs, NUM_SLICE, df, data_name, shotname, keys_list, namespace=None, dpi=200, oneline=True) # for one line.
