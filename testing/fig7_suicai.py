...
def test():
    ...
    # ourtta, theone = 'ixi_t1_periodic_moderate_coronal', 100
    ourtta, theone = 'ixi_pd_periodic_moderate', 100
    ...
    with torch.no_grad():
        for x_iter in dataloader:
            ...
            recon_bsa = NormalizeData(imgs['Ours'], datarange=255)
            corrupted = NormalizeData(imgs['Corrupted'], datarange=255)
            cv2.imwrite('./recon.jpg', recon_bsa)
            cv2.imwrite('./corrupted.jpg', corrupted)
