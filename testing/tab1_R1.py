...
def pandas_group_by(all_df, name, shot_shot_filename):
    ...
    formatted_data = process_data(df)
...
def process_data(df):
    ...
    method_order = ['Corrupted', 'MARC', 'PE', 'cycleGAN', 'BSA', 'Ours', 'Supervised']
...
def read_excel_and_plot(tabs, name, pdf_or_png):
    ...
    pandas_group_by(all_df, name, shot_shot_filename)
...
if __name__ == "__main__":
    ...
    conditional_filename =  './results/{}/'.format(filename) 
    mkdir(conditional_filename)

    tab1_a = {
                
                "Linear": './results/fig6ploseone_linear/MR_ART_Axial_None20240221-163247.xlsx',
                "Nonlinear": './results/fig6ploseone_nonlinear/MR_ART_Axial_None20240221-171546.xlsx',
                "Sudden": './results/fig6ploseone_sudden/MR_ART_Axial_None20240221-172745.xlsx',
                "Single-shot": './results/fig6ploseone_singleshot/MR_ART_Axial_None20240221-173944.xlsx',
                "RL": './results/fig6ploseone_RL/MR_ART_Axial_None20240221-175611.xlsx',
                "Moderate": './results/fig6ploseone_moderate/MR_ART_Axial_None20240221-180823.xlsx',
                "Heavy": './results/fig6ploseone_heavy/MR_ART_Axial_None20240221-182024.xlsx',
    }

    name = conditional_filename + 'tab1_a'
    pdf_or_png = 'png'

    read_excel_and_plot(tab1_a, name, pdf_or_png)
