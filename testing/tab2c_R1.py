...
def pandas_group_by(all_df, name, keys_list_order, shot_shot_filename):
    ...
    formatted_data = process_data(df, keys_list_order)
...
def process_data(df, keys_list_order):
...
def read_excel_and_plot(tabs, name, keys_list_order, pdf_or_png):
    ...
    pandas_group_by(all_df, name, keys_list_order, shot_shot_filename)
...
if __name__ == "__main__":
    ...
    tab1_a = {
                ...
                "S_fastMRI": './results/fig2c1/MR_ART_Axial_None20240222-090427.xlsx',
                "M_fastMRI": './results/fig2c2/MR_ART_Axial_None20240222-090656.xlsx',
                # "S_ANDI": './results/fig2c3/MR_ART_Axial_None20230425-015733.xlsx',
                # "M_ANDI": './results/fig2c4/MR_ART_Axial_None20230425-020620.xlsx',
    }

    name = conditional_filename + 'tab_'
    pdf_or_png = 'png'
    keys_list_order = list(tab1_a.keys())
    read_excel_and_plot(tab1_a, name,keys_list_order, pdf_or_png)
