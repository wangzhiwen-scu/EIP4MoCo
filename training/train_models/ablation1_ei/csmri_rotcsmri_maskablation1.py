...
from layers.mask_layer import Hand_Tailed_Mask_Layer_maskablation
...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        self.ckpt = './model_zoo/mask_ablation/{}_{}.pth'.format(args.ablation_which, str(args.ablation_var))
        ...
        self.sample_net = Hand_Tailed_Mask_Layer_maskablation(args.ablation_which, args.ablation_var).to(device, dtype=torch.float)
        # self.model = Unet().to(device, dtype=torch.float)
