...
% JFPJ Abascal, L Cuss?, J J Vaquero, M Desco. Application of the
...
% load('sim_2dmri.mat', 'sim_2dmri')

my_path = 'F:\library\Paper\motion_artifacts\TCSVT-R1\R1\rec_motion_paried_IXI054-Guys-0707-T1.nii_753_mask.png.mat';
load(my_path)
